      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
        <label className="space-y-1">
          ...
          <select
            ...
            className="w-full border rounded px-2 py-1.5 sm:px-3 sm:py-2 text-xs sm:text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
        ...
        <label className="space-y-1">
          ...
          <div className="relative" ref={categoryDropdownRef}>
            <button
              ...
              className="w-full border rounded px-2 py-1.5 sm:px-3 sm:py-2 text-xs sm:text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-left flex items-center justify-between disabled:opacity-50 disabled:cursor-not-allowed"
